  ...
  return (
    <div className="flex items-center justify-end gap-1">
      ...
      <button
        type="button"
        onClick={onDelete}
        className="inline-flex h-8 items-center gap-1.5 rounded-lg px-2.5 text-xs font-semibold text-rose-600 transition-colors hover:bg-rose-500/10 dark:text-rose-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500"
      >
        <Trash2 size={14} />
        <span>Delete</span>
      </button>
